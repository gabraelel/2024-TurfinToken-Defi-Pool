...
//SETTINGS Kovan Testnet (B4 uncomment, comment for BSC)

 export const CHAIN_ID = 42

 export const contractAddresses = {
   sushi: {
     42: '0x90e47E584863f24Db86931E7613868927ac23065',
   },
   masterChef: {
     42: '0x1434C566d771c3535A438987877782bCB9bA61c4',
   },
   weth: {
     42: '0xc778417e063141139fce010982780140aa0cd5ab',
   },
   xSushi: {
 ...
 export const supportedPools = [
   {
     ...
     tokenAddresses: {
       42: '0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa', // Token, i.e. "DAI"
     },
     name: 'DAI-ETH LP',
     symbol: 'DAI-ETH LP',
     tokenSymbol: 'DAI',
